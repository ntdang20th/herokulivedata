        ...
        try:
            ...
            for i in range(60):
                ...
                data = {'date': str(datetime.datetime.now()),
                        'UUID': 'bea44629-1aea-4404-b88c-7a0a0519b35d', 'Touch': 'no touch detected',
                ...
                def run(self):
                    try:
                        ...
                        for i in range(60):
                            ...
                            data = {'date': str(datetime.datetime.now()),
                                    'UUID': '68164eba-6d25-4d8b-982b-8f0803d21dff', 'Touch': 'touch detected',
                                    'data': [acceleration_sensor.getJson(), gyroscope_sensor.getJson(),
                                             rotation_sensor.getJson()]}
